...
registerOnClick('sillen', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam02', 'camlook2', 1, function() {}, 0);
}, function(event) {});

registerOnClick('panatalla', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam01', 'camlookup1', 1, function() {}, 0);
}, function(event) {});
